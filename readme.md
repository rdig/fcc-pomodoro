...
The project is a simple pomodoro timer.

This was build to complete a [FreeCodeCamp challenge](http://www.freecodecamp.com/challenges/build-a-pomodoro-clock). You can use the code as you see fit, just don't use my personal name (scrub it out). See [license](./license.md).

## Features

- Modifiable time length for the pomodoro and the break
